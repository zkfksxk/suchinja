...
export const QUESTION_LIST: Questions = [
  ...
  {
    id: 8,
    question: '수영 대회나 기록 측정회에 나간 적 있니?',
    answers: [
      { id: 1, text: '기록 갱신이 목표! 대회는 나만의 축제.' },
      { id: 2, text: '한두 번은 나가봤지만 경험용이었어요.' },
      { id: 3, text: '그런 건 선수들만 나가는 거 아님?' },
    ],
  },
  {
    id: 9,
    ...
    answers: [
      { id: 1, text: '이미 자격증 따거나 준비중이고 물속 세상에 빠졌어요.' },
      { id: 2, text: '관심은 있지만 아직 도전해보진 않았어요.' },
      { id: 3, text: '저는 그냥 수영파.' },
    ],
  },
  {
    ...
    answers: [
      { id: 1, text: '오리발 장착하면 내가 돌핀이다.' },
      { id: 2, text: '가끔 사용하는데 좀 어색하다.' },
      { id: 3, text: '그거 쓰면 다리에 쥐 날 거 같아서 안 써요.' },
    ],
  },
];
